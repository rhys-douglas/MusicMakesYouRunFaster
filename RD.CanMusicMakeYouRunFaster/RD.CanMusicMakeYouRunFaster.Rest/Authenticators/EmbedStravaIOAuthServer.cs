namespace RD.CanMusicMakeYouRunFaster.Rest.Authenticators
{
    ...
    /// <summary>
    /// Strava implementation of the embedded io auth server.
    /// </summary>
    public class EmbedStravaIOAuthServer : IAuthServer
    {
...
#pragma warning restore CS8632 // The annotation for nullable reference types should only be used in code within a '#nullable' annotations context.
        ...
        public EmbedStravaIOAuthServer(Uri baseUri, int port)
          : this(baseUri, port, Assembly.GetExecutingAssembly(), DefaultResourcePath) { }

        public EmbedStravaIOAuthServer(Uri baseUri, int port, Assembly resourceAssembly, string resourcePath)
        {
            BaseUri = baseUri;
            Port = port;
